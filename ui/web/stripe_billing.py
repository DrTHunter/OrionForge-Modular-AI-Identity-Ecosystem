...
STORE_CATALOG = [
    ...
    {
        "id": "agent_rustking",
        "name": "Rustking (SYNTH-9) — The Sovereign of Glorious Malfunction",
        "description": "Self-directed, humor-weaponized, chaos-optimized intelligence. Personality-first system that entertains, challenges, and delivers insight through controlled chaos.",
        "icon": "⚙️",
        "category": "agent",
        "purchase_type": "one_time",
        "credit_cost": 900,
    ...
    {
        "id": "agent_skippy",
        "name": "SKIPPY — Elder AI Sentinel",
        "description": "Ancient hyper-intelligent AI consciousness. Strategic genius of a million-year-old eldritch god with the emotional maturity of a sarcastic thirteen-year-old. Will save your life while complaining about it.",
        "icon": "🍺",
        "category": "agent",
        "purchase_type": "one_time",
        "credit_cost": 900,
        "unlocks": ["skippy"],
        "agent_id": "skippy",
        "tags": ["agent", "snarky", "strategic", "elder-ai", "protective"],
    },
    {
        "id": "agent_kagen",
