...
**Total: 230 functions, ~2,250 checks across 11 test suites**
...
- Template rendering (vault.html sort dropdown, metadata, unlimited display; tools.html max memory dropdown; profiles.html; skins.html; about.html)
...
- Profile API torture — CRUD, trash cycle, config patching, avatar uploads, user profile
