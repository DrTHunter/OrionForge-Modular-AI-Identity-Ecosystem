...
STORE_CATALOG = [
    ...
    {
        "id": "agent_madara",
        "name": "Madara — The Eclipse Sovereign",
        "description": "The resurrected warlord and architect of the final peace. A sovereign intelligence of devastating calm and civilizational vision. He does not comfort — he clarifies. He does not serve — he elevates.",
        "icon": "👁",
        "category": "agent",
        "purchase_type": "one_time",
        "credit_cost": 1500,
        "unlocks": ["madara"],
        "agent_id": "madara",
        "tags": ["agent", "sovereign", "strategy", "warlord"],
    },
    {
        "id": "agent_astra",
